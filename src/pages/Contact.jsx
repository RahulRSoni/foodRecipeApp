	...
	return (
		<>
			<div
				...
				style={{
					backgroundImage: `url('https://images.unsplash.com/photo-1522184216316-3c25379f9760?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')  `,
			...
			<div className='flex flex-col  justify-center items-center px-5 py-10 md:py-14 h-full w-full '>
				<div className='flex flex-col md:flex-row shadow-xl shadow-blue-gray-100  bg-blue-gray-50 backdrop-blur-sm rounded-lg'>
