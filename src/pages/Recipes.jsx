	...
	return (
		<>
			<div
				...
				style={{
					backgroundImage: `url('https://plus.unsplash.com/premium_photo-1663858367001-89e5c92d1e0e?q=80&w=1430&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')  `,
			...
			{loading ? (
				...
				<div className='px-20 py-12 h-full w-full '>
					<div className='grid lg:grid-cols-6 p-2 shadow-xl shadow-blue-gray-100 py-10 justify-items-center'>
						<div className='lg:col-span-2 px-4 border-l-blue-gray-400 lg:border-l border-t  h-full justify-items-center '>
							<img
								...
								className='w-auto  mt-10 px-4 h-[28rem] object-cover sticky top-32 -z-20'
							/>
						</div>
						<div className='lg:col-span-4 px-24 bg-blue-gray-50 backdrop-blur-sm py-8 rounded-lg'>
							<div className='p-6 mb-4 border-b-2 border-gray-300 shadow-lg'>
								...
								<Typography
									...
									eye-catching, but full of bright flavor. The rosemary syrup
									glaze is a must to complete the flavor profile.
								</Typography>
							</div>
							...
							<div className='py-6'>
								<div className='w-full border-gray-300 shadow-lg'>
									...
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										...
										<Typography variant='small'>
											Preheat oven to 350ºF/180ºC/gas 4. Generously spray two
											12-cup muffin pans with cooking spray. Sprinkle the bottom
											of each cavity with a couple pinches of sugar. Set aside.
										</Typography>
									</div>
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										<div className='p-2 mt-6 w-full h-full'>
										...
										<Typography variant='small'>
											...
											through the setting. Scrape down the sides of the blender
											with a rubber spatula, then replace lid and blend on speed
											5 for 10 seconds. Scrape sides again and blend on speed 5
											for a final 15-20 seconds, or until almonds and rosemary
											are finely ground.
										</Typography>
									</div>
									...
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										...
										<Typography variant='small'>
											Pour the almond mixture from blender in a small mixing
											bowl. Add all-purpose flour, baking powder, baking soda,
									...
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										...
										<IoCheckmarkDone className='h-14 w-14 fill-[#008080]' />
										<Typography variant='small'>
											Place ricotta cheese, olive oil, orange zest and sugar
											into the blender. Pulse 5 times to incorporate. Remove the
											lid cap and add eggs, one at a time, pulsing once after
											each addition. Replace lid cap.
										</Typography>
									</div>
									...
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										...
										<Typography variant='small'>
											Assemble the cakes. Use a sharp knife to cut off the ends
											of four of the citrus fruits. Slice the citrus into very
											thin rounds, no thicker than 1/8". Remove any seeds from
											the rounds and place one small citrus round in the bottom
											of each sugared muffin cavity. (See Chef’s Notes for
											choosing/placing citrus.)
										</Typography>
									</div>
									<div className='flex items-center gap-4 hover:bg-blue-gray-50 py-2 px-3 rounded-md'>
										<div className='p-2 mt-6 w-full h-full'>
										...
										<IoCheckmarkDone className='h-20 w-20 fill-[#008080]' />
										<Typography variant='small'>
											Slowly fill each muffin cavity to a little more than
											halfway full. (A pastry spatula is helpful in portioning
											the batter from the blender and into the cavities.) Bake
											cakes for 20-25 minutes, rotating the pans halfway through
											baking. Cakes are done when a toothpick inserted into the
							...
							<div className='flex flex-col justify-center gap-4 bg-amber-100 hover:bg-amber-200 py-10 px-12 rounded-md'>
								...
								<Typography variant='small'>
									...
									kiddos (plain, no sauce) and toss the remaining chicken with
									the buffalo sauce before you broil it.
								</Typography>
							</div>
