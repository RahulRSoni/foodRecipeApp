	...
	return (
		<div className='px-20 py-20 h-full w-full'>
			<div className='grid lg:grid-cols-6 p-2'>
				<div className='lg:col-span-2 px-4 border-l-blue-gray-400 lg:border-l border-t justify-items-left h-full'>
					<img
						alt='demo'
						...
						className='w-4/12 fixed overflow-y-auto px-4 h-[28rem] object-cover'
					/>
				</div>
				<div className='lg:col-span-4 px-24'>
					<div className='py-6 mb-4 border-b-2 border-gray-300 shadow-lg'>
						<Typography
							variant='h3'
